...
<div className="plans-logos">
  ...
  <span>… e particular</span>
            ...
            <div className="actions">
              ...
              <a
                href="https://wa.me/5579991160780?text=Olá%20Taise,%20gostaria%20de%20saber%20valores%20e%20disponibilidade."
                target="_blank"
                rel="noreferrer"
          ...
          <div className="gallery-grid">
            {images.map((image, index) => (
              <div key={index} className="gallery-item image-frame small-gallery-item">
                <img
                  src={image}
